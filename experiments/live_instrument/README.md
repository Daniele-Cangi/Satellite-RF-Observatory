...
| Same-Kiwi DDC cut | `kiwi_gate_f2_3.py` through `kiwi_gate_f2_5_5.py` | topology audit, atomic direct-SND qualification, failure attribution and an offline protocol-evidence boundary |
