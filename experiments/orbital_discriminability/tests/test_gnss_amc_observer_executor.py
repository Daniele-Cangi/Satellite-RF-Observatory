...
from experiments.orbital_discriminability import (
    gnss_amc_observer_executor as executor,
)
from experiments.orbital_discriminability import (
...
def test_manifest_is_one_product_observation_blind_and_no_fit() -> None:
    ...
    assert manifest["product"]["station"] == "AMC400USA"
...
def test_scoring_has_no_prefix_fit_and_uses_strict_guard() -> None:
    ...
    assert above["outcome"] == "AMC_HELD_OUT_ORBITAL_MODEL_PREFERRED"
...
def test_strict_json_rejects_nonfinite_values() -> None:
    ...
    assert datetime.fromisoformat("2026-08-09T05:41:30+00:00").tzinfo is not None
