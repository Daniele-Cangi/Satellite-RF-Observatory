"""Extend exposed G14 references to a fixed hour; never parse target states."""
import argparse
...
def prepare(work, products, celestial_raw, output):
    ...
    plan_raw = (BASE/'hour_reference_plan.json').read_bytes()
    ...
    receipt = {'schema':'hour-reference-input-v1', 'plan_sha256':sha(plan_raw), 'sources_sha256':deps,
