...
def parse_weather(raw, mjd):
    ...
    for line in raw.decode('ascii').splitlines():
        ...
        if not (0 < ah < .01 and 0 < aw < .01 and 0 < zhd < 4 and 0 <= zwd < 2 and 0 < pressure < 1200 and -100 < temperature < 100 and 0 <= vapor < 150):
    ...
    for tag, day, mjd in [('g14', 246, 61286), ('g12', 248, 61288)]:
        ...
        for station in STATIONS:
            for hour in (0, 6, 12, 18):
                ...
                rows.append(row)
    return {'schema': 'atmosphere-zenith-sensitivity-v1',
